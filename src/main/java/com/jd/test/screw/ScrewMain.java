...
public class ScrewMain {
    private static final String DB_URL = "jdbc:mysql://101.43.63.132:3306";//"jdbc:mysql://rm-wz973i417695x57663o.mysql.rds.aliyuncs.com:3306";
    private static final String DB_NAME = "yuce";
    private static final String DB_USERNAME = "root";//"baseus_dev";
    private static final String DB_PASSWORD = "lucky";

    private static final String FILE_OUTPUT_DIR = "C:/Users/TD/Desktop/文档/";
    private static final EngineFileType FILE_OUTPUT_TYPE = EngineFileType.MD; // 可以设置 Word 或者 Markdown 格式
    private static final String DOC_FILE_NAME = "预测平台-数据库文档";
